...
#gross pay
num2 = driver.find_element(By.XPATH, "//tbody[1]/tr[4]/td[8]/p-celleditor[1]/p-inputnumber[1]/span[1]/input[1]")
#bonus
value3 = 56400
...
#grosspay-bonus-salary
time.sleep(5)
# Get actual result value
result_element = driver.find_element(By.XPATH, "//tbody[1]/tr[4]/td[9]/p-celleditor[1]/p-inputnumber[1]/span[1]/input[1]")
#advance
actual_sum = int(result_element.get_attribute("aria-valuenow"))
# Compare the values
if expected_sum == actual_sum:
    print("The advance is correct")
else:
    print("The advance is incorrect")
