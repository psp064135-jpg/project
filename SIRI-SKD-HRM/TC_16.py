...
#bonus
num3 = driver.find_element(By.XPATH, "//tbody[1]/tr[4]/td[9]/p-celleditor[1]/p-inputnumber[1]/span[1]/input[1]")
#advance
...
#grosspay-bonus-advance
time.sleep(5)
# Get actual result value
actual_sum =  56400
# Compare the values
if expected_sum == actual_sum:
    print("The salary  is correct")
else:
