...
import time
# for calcuating the deduection pay
...
#gross pay
num2 = driver.find_element(By.XPATH, "//tbody[1]/tr[4]/td[14]/p-celleditor[1]/p-inputnumber[1]/span[1]/input[1]")
#net pay
...
value2 = int(num2.get_attribute("aria-valuenow"))
 ...
 #Calculations for deduction in salary
expected_sum = value1 - value2
#grosspay-net pay
time.sleep(5)# Get actual result value
result_element = driver.find_element(By.XPATH, "//tbody[1]/tr[4]/td[15]/p-celleditor[1]/p-inputnumber[1]/span[1]/input[1]")
actual_sum = int(result_element.get_attribute("aria-valuenow"))
# Compare the values
if  expected_sum == actual_sum:
    print("The deduction pay is correct")
else:
    print("The deduction pay is incorrect")
